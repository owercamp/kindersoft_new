                ...
                <form wire:submit.prevent="save">
                  ...
                  <div class="flex flex-row gap-4 mb-4 w-full">
                    <div class="flex flex-col basis-3/6">
                      ...
                      <x-input type="text" min="0" maxlength="4" class="border p-2 rounded w-full" wire:model="create.register" id="register" value="{{ $create['register'] }}" />
