...
class Transportation extends Component
{
  ...
  {
    $number_register = DB::table('transports')->latest('register')->value('register') + 1;
  ...
  {
    $this->reset('data');
    $journay = Transport::with('status')->find($register);
  ...
  public function edit()
  {
    ...
    $journay = Transport::find($this->data['id']);
  ...
  public function delete(Transport $register)
  {
  ...
  {
    $transportation = Transport::with('status')->orderBy('register')->paginate(15);
    return view('livewire.configurations.products-and-services.transportation', compact('transportation'));
  }
}
