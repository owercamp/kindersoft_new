...
{
  static function saveLogistic(NotificationForm $form)
  {
    $path = null;
    DB::beginTransaction();
    try {
  ...
  static function editLogistic(NotificationForm $form, int $id)
  {
    $path = null;
  ...
  static function destroyLogistic(int $id)
  {
  ...
  static function getLogistic()
  {
    $registers = Notification::where('type', 'logistic')->paginate(10);
    return $registers;
  }
